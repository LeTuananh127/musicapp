...
class _SearchTrackScreenState extends ConsumerState<SearchTrackScreen> {
  ...
  Future<void> _loadPage(String q) async {
    ...
    try {
      ...
      final res = await dio.get('$base/tracks/search',
          queryParameters: {'q': q, 'limit': _pageSize, 'offset': _offset});
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
                onPressed: _loading ? null : _search, child: const Text('Tìm')),
            const SizedBox(height: 8),
                      ...
                      onTap: () {
                        final t = Track(
                          ...
                          durationMs: (r['duration_ms'] is int)
                              ...
                              : (r['duration_ms'] is num
                                  ? (r['duration_ms'] as num).toInt()
                                  : 0),
